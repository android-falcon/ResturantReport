...
final kStyleHeaderTable = TextStyle(fontWeight: FontWeight.bold, fontSize: 13.sp, color: myColors.primarycolor_);
...
final kStyleTextButton = TextStyle(fontWeight: FontWeight.bold, fontSize: 15.sp, color: Colors.white);
